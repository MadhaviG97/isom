...
HD_PWD='/home/mad/Documents/Projects/isom/isom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log isom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source isom.tcl
